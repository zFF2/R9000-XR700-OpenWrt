...
SQUASHFSOPT += $(if $(strip $(CONFIG_TARGET_SQUASHFS_BLOCK_READERS)),-block-readers $(strip $(CONFIG_TARGET_SQUASHFS_BLOCK_READERS)))
SQUASHFSOPT += $(if $(strip $(CONFIG_TARGET_SQUASHFS_SMALL_READERS)),-small-readers $(strip $(CONFIG_TARGET_SQUASHFS_SMALL_READERS)))
SQUASHFSCOMP := gzip
